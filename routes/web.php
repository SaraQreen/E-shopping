...
Route::post('/contact-form',[HomeController::class,'insert'])->name('contact.insert');
...
Route::get('/product-detail/{id}',[IndexController::class,'detailpro']);
...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    Route::get('delete-product/{id}',[ProductsController::class,'destroy'])->name('product.destroy');
