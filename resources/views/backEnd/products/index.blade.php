            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            <td>{{$i}}</td>
                            <td style="text-align: center;"><img src="{{url('images/products/',$product->image)}}" alt="" width="50"></td>
                        ...
                        <div id="myModal{{$product->id}}" class="modal hide">
                            ...
                            <div class="modal-body">
                                <div class="text-center"><img src="{{url('images/products/',$product->image)}}" width="100" alt="{{$product->p_code}}"></div>
